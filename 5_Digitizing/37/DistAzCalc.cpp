...
int main(int argc, char **argv){
    ...
    double NP_EV_LON=149.946,CP_EV_LON=183.638,CA_EV_LON=276.545,SA_EV_LON=288.792;
    double NP_EV_LAT=47.776 ,CP_EV_LAT=-18.538,CA_EV_LAT=9.780  ,SA_EV_LAT=-15.245;
    double NP_ST_LON=239.409,CP_ST_LON=239.520,CA_ST_LON=238.008,SA_ST_LON=239.401;
    double NP_ST_LAT=37.101 ,CP_ST_LAT=37.147 ,CA_ST_LAT=46.062 ,SA_ST_LAT=37.198;

	printf("NP: %.1lf\t%.1lf\n",gcpdistance(NP_EV_LON,NP_EV_LAT,NP_ST_LON,NP_ST_LAT)
                               ,center_az(NP_EV_LON,NP_EV_LAT,NP_ST_LON,NP_ST_LAT));
	printf("CP: %.1lf\t%.1lf\n",gcpdistance(CP_EV_LON,CP_EV_LAT,CP_ST_LON,CP_ST_LAT)
                               ,center_az(CP_EV_LON,CP_EV_LAT,CP_ST_LON,CP_ST_LAT));
	printf("CA: %.1lf\t%.1lf\n",gcpdistance(CA_EV_LON,CA_EV_LAT,CA_ST_LON,CA_ST_LAT)
                               ,center_az(CA_EV_LON,CA_EV_LAT,CA_ST_LON,CA_ST_LAT));
	printf("SA: %.1lf\t%.1lf\n",gcpdistance(SA_EV_LON,SA_EV_LAT,SA_ST_LON,SA_ST_LAT)
                               ,center_az(SA_EV_LON,SA_EV_LAT,SA_ST_LON,SA_ST_LAT));
