...
int main(int argc, char **argv){
    ...
    double IJK_EV_LON=146.066,TF_EV_LON=180.630,SA_EV_LON=292.650;
    double IJK_EV_LAT=43.806,TF_EV_LAT=-22.703,SA_EV_LAT=-21.599;
    double ST_LON=239.36,ST_LAT=36.878;

	printf("IJK: %.1lf\t%.1lf\n",gcpdistance(IJK_EV_LON,IJK_EV_LAT,ST_LON,ST_LAT)
                               ,center_az(IJK_EV_LON,IJK_EV_LAT,ST_LON,ST_LAT));
	printf("TF: %.1lf\t%.1lf\n",gcpdistance(TF_EV_LON,TF_EV_LAT,ST_LON,ST_LAT)
                               ,center_az(TF_EV_LON,TF_EV_LAT,ST_LON,ST_LAT));
	printf("SA: %.1lf\t%.1lf\n",gcpdistance(SA_EV_LON,SA_EV_LAT,ST_LON,ST_LAT)
                               ,center_az(SA_EV_LON,SA_EV_LAT,ST_LON,ST_LAT));
