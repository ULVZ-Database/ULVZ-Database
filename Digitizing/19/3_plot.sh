...
psxy line_yes ${REG} ${PROJ} -m -Sc0.01i -Gyellow -O -K >> ${OUTFILE}
# psxy line_no ${REG} ${PROJ} -m -Sc0.01i -Gyellow -O -K >> ${OUTFILE}
psxy Data.Pdiff.NWP.yes.area ${REG} ${PROJ} -m -L -W2p,green,faint -O -K >> ${OUTFILE}
